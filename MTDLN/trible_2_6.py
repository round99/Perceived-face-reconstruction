...
last_layer = vgg_model.get_layer('pool2').output

x1 = Conv2D(256, (3, 3), activation='relu', padding='same', name='emo_conv3_1')(last_layer)
...
x2 = Conv2D(256, (3, 3), activation='relu', padding='same', name='id_conv3_1')(last_layer)
...
x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='gen_conv3_1')(last_layer)
...
for layer in custom_vgg_model.layers[:7]:
