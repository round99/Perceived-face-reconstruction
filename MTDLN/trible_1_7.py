...
last_layer = vgg_model.get_layer('pool1').output

x1 = Conv2D(128, (3, 3), activation='relu', padding='same', name='emo_conv2_1')(last_layer)
x1 = Conv2D(128, (3, 3), activation='relu', padding='same', name='emo_conv2_2')(x1)
x1 = MaxPooling2D((2, 2), strides=(2, 2), name='emo_pool2')(x1)
x1 = Conv2D(256, (3, 3), activation='relu', padding='same', name='emo_conv3_1')(x1)
x1 = Conv2D(256, (3, 3), activation='relu', padding='same', name='emo_conv3_2')(x1)
x1 = Conv2D(256, (3, 3), activation='relu', padding='same', name='emo_conv3_3')(x1)
x1 = MaxPooling2D((2, 2), strides=(2, 2), name='emo_pool3')(x1)
x1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='emo_conv4_1')(x1)
...
x2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='id_conv2_1')(last_layer)
x2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='id_conv2_2')(x2)
x2 = MaxPooling2D((2, 2), strides=(2, 2), name='id_pool2')(x2)
x2 = Conv2D(256, (3, 3), activation='relu', padding='same', name='id_conv3_1')(x2)
x2 = Conv2D(256, (3, 3), activation='relu', padding='same', name='id_conv3_2')(x2)
x2 = Conv2D(256, (3, 3), activation='relu', padding='same', name='id_conv3_3')(x2)
x2 = MaxPooling2D((2, 2), strides=(2, 2), name='id_pool3')(x2)
x2 = Conv2D(512, (3, 3), activation='relu', padding='same', name='id_conv4_1')(x2)
...
x3 = Conv2D(128, (3, 3), activation='relu', padding='same', name='gen_conv2_1')(last_layer)
x3 = Conv2D(128, (3, 3), activation='relu', padding='same', name='gen_conv2_2')(x3)
x3 = MaxPooling2D((2, 2), strides=(2, 2), name='gen_pool2')(x3)
x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='gen_conv3_1')(x3)
x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='gen_conv3_2')(x3)
x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='gen_conv3_3')(x3)
x3 = MaxPooling2D((2, 2), strides=(2, 2), name='gen_pool3')(x3)
x3 = Conv2D(512, (3, 3), activation='relu', padding='same', name='gen_conv4_1')(x3)
...
accemo=history1.history['emo_fc8_accuracy']
accid=history1.history['id_fc8_accuracy']
accgen=history1.history['gen_fc8_accuracy']
