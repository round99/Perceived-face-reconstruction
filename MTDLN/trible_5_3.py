...
x1 = Dense(hidden_dim, activation='relu', name='emo_fc6', kernel_regularizer=regularizers.l2(0.001))(last_layer)
...
x2 = Dense(hidden_dim, activation='relu', name='id_fc6', kernel_regularizer=regularizers.l2(0.001))(last_layer)
...
x3 = Dense(hidden_dim, activation='relu', name='gen_fc6', kernel_regularizer=regularizers.l2(0.001))(last_layer)
