...
x1 = Dense(hidden_dim, activation='relu', name='emo_fc7', kernel_regularizer=regularizers.l2(0.001))(x)
x1 = Dropout(dropout_rate)(x1)
out1 = Dense(nb_class1, activation='softmax', name='emo_fc8', kernel_regularizer=regularizers.l2(0.001))(x1)
# out1表情


x2 = Dense(hidden_dim, activation='relu', name='id_fc7', kernel_regularizer=regularizers.l2(0.001))(x)
...
x3 = Dense(hidden_dim, activation='relu', name='gen_fc7', kernel_regularizer=regularizers.l2(0.001))(x)
